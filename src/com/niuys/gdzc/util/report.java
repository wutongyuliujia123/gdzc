...
import com.javareport.beans.Table;
...
public  class report {
  public static Report  getData(HttpServletRequest request){
    ...
    //------得到销售情况一览表对象------
    public static Table getTableA(ArrayList<ZcInfo> list){
    ...
    public static String[][] getData(ArrayList<ZcInfo> list){
