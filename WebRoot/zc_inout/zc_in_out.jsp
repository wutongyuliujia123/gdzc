...
<html>
	...
	<body>
	  ...
	  <tr>
		  ...
		  <tr>
				<td>
				<img src="images/9.gif" width="36" height="30">
			...
			<tr>
				...
				<label>
					...
					<img src="images/weifu.gif" width="30" height="30"><strong>资产编号：</strong>
<input name="zc_id" type="text" class="logininput" id="zc_id" size="30">
														&nbsp;&nbsp;&nbsp;&nbsp;
					<img src="images/11.gif" width="46" height="33"><strong>员工编号：</strong>
