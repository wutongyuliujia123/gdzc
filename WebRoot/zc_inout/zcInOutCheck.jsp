  ...
  <table width="100%" border="0" align="center">
    <tr>
      <td><table width="98%" border="0" align="center">
        <tr>
          <td><img src="images/weifu.gif" width="30" height="30"><span class="word_orange2"><strong>资产借出归还信息浏览/查询</strong></span></td>
        </tr>
        <tr>
          <td><hr align="center" size="1" noshade></td>
        </tr>
        <tr>
          <td><form name="myform" method="post" action="zcInOut.do">
            <table width="98%" border="0" align="center" background="images/bg.gif" class="tableBorder">
              ...
              <tr>
                ...
                <td width="12%"><img src="images/point.gif" width="17" height="16">员工编号：</td>
                <td width="43%"><label>
