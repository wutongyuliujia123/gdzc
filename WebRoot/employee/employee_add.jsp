...
<html>
	<head>
		...
		<script language="javascript" type="text/javascript"
			src="  js/check_addEmployee.js"></script>

		<script language="javascript" type="text/javascript"
			src="  js/pinbi.js"></script>
	</head>
			...
			<tr>
				<td>
					<html:form method="post" action="addEmployeeInfo">
						<table width="100%" border="0" background="  images/bg.gif"
							class="tableBorder">
							<tr>
								<td colspan="2">
									<img src="  images/4.gif" width="39" height="34">
							...
							<tr>
								<td width="20%" height="41"
									...
									<span class="word_Green"><img
											src="  images/point.gif" width="17" height="16">员工编号：</span>
								</td>
								<td width="80%">
									<label>
							...
							<tr>
								<td height="39" background="  images/background.jpg">
									<span class="word_Green"><img
											src="  images/point.gif" width="17" height="16">姓名：</span>
								</td>
								<td>
									<label>
							...
							<tr>
								<td height="34" background="  images/background.jpg">
									<span class="word_Green"><img
											src="  images/point.gif" width="17" height="16">性别：</span>
								</td>
								<td>
									<label>
							...
							<tr>
								<td height="36" background="  images/background.jpg">
									<span class="word_Green"><img
											src="  images/point.gif" width="17" height="16">年龄：</span>
								</td>
								<td>
									<label>
							...
							<tr>
								<td height="37" background="  images/background.jpg">
									<span class="word_Green"><img
											src="  images/point.gif" width="17" height="16">所在部门：</span>
								</td>
								<td>
									<label>
							...
							<tr>
								<td height="38" background="  images/background.jpg">
									<span class="word_Green"><img
											src="  images/point.gif" width="17" height="16">现任职务：</span>
								</td>
								<td>
									<label>
							...
							<tr>
								<td height="36" background="  images/background.jpg">
									<span class="word_Green"><img
											src="  images/point.gif" width="17" height="16">家庭地址：</span>
								</td>
								<td>
									<label>
							...
							<tr>
								<td height="36" background="  images/background.jpg">
									<span class="word_Green"><img
											src="  images/point.gif" width="17" height="16">联系方式：</span>
								</td>
								<td>
									<label>
							...
							<tr>
								<td height="35" background="  images/background.jpg">
									<span class="word_Green"><img
											src="  images/point.gif" width="17" height="16">员工状态：</span>
								</td>
								<td>
									<label>
