...
<html>
  <head>
	...
	<script language="javascript" src="js/check_updatePwd.js"></script>
  ...
  <table width="60%" border="0" align="center">
    <tr>
      <td><table width="98%" border="0" align="center">
        <tr>
          <td><img src="images/weifu.gif" width="30" height="30"><span class="word_orange STYLE1"><strong>系统用户修改密码</strong></span></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <html:form  method="post" action="updatepwd">
            <table width="98%" border="0" align="center" background="images/bg.gif" class="tableBorder">
              ...
              <tr>
                <td height="30" >&nbsp;</td>
                <td><img src="images/point.gif" width="17" height="16">用户名：</td>
                <td><label>
              ...
              <tr >
                <td height="29">&nbsp;</td>
                <td><img src="images/point.gif" width="17" height="16">旧密码：</td>
                <td>
                <label>
              ...
              <tr>
                <td height="30">&nbsp;</td>
                <td><img src="images/point.gif" width="17" height="16">新密码：</td>
                <td><label>
              ...
              <tr>
                <td height="31">&nbsp;</td>
                <td><img src="images/point.gif" width="17" height="16">确认密码：</td>
                <td><label>
