  ...
  <table width="100%" border="0" align="center">
    <tr>
      <td><table width="98%" border="0" align="center">
        <tr>
          <td><img src="images/weifu.gif" width="30" height="30"><span class="word_orange2"><strong>资产信息浏览/查询</strong></span></td>
        </tr>
        <tr>
        ...
        <tr>
          <td><html:form method="post" action="checkzc">
            <table width="98%" border="0" align="center" background="images/bg.gif" class="tableBorder">
              <tr>
                <td colspan="4"><img src="images/point.gif" width="17" height="16"><span class="word_orange"><strong>填写查询条件</strong></span></td>
              </tr>
              <tr>
                <td width="12%" height="24"><img src="images/point.gif" width="17" height="16">资产编号：</td>
                <td width="32%"><label>
                  <html:text property="zc_id" styleClass="logininput" size="30"></html:text>
                </label></td>
                <td width="12%"><img src="images/point.gif" width="17" height="16">生产厂商：</td>
                <td width="43%"><label>
                 <html:text property="zc_factory" styleClass="logininput" size="30"></html:text>
                </label></td>
              </tr>
              <tr>
                <td height="24"><img src="images/point.gif" width="17" height="16">资产型号：</td>
                <td><label>
                 <html:text property="zc_no" styleClass="logininput" size="30"></html:text>
                </label></td>
                <td><img src="images/point.gif" width="17" height="16">资产类型：</td>
                <td><label>
              ...
              <tr>
                <td height="24"><img src="images/point.gif" width="17" height="16">资产名称：</td>
                <td><label>
              ...
              <tr>
                <td height="24"><img src="images/point.gif" width="17" height="16">购买人：</td>
                <td><label>
