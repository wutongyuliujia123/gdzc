...
<html>
  <head>
    ...
    <SCRIPT language="JavaScript" src="js/check_addZcInfo.js"></SCRIPT>
  ...
  <table width="55%" border="0" align="center">
    <tr>
      ...
      <html:form method="post" action="add">
        <table width="100%" border="0" background="images/bg.gif" class="tableBorder">
          <tr>
            <td colspan="2"><img src="images/weifu.gif" width="30" height="30"><span class="word_orange2"><strong>资产信息添加</strong></span><font color=red>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          </tr>
          <tr>
           ...
           <tr>
            <td width="21%" height="41" background="images/background.jpg"><img src="images/point.gif" width="17" height="16"><span class="word_Green">资产编号：</span></td>
            <td width="79%"><label>
          ...
          <tr>
            <td width="21%" height="41" background="images/background.jpg"><img src="images/point.gif" width="17" height="16"><span class="word_Green">资产型号：</span></td>
            <td width="79%"><label>
              <html:text property="zc_no" styleClass="logininput" size="30"></html:text><font color=red><html:errors property="zc_no"/></font>
            </label></td>
          </tr>
          <tr>
            <td height="39" background="images/background.jpg"><img src="images/point.gif" alt="" width="17" height="16"><span class="word_Green">资产名称：</span></td>
            <td><label>
              <html:text property="zc_name" styleClass="logininput" size="30"></html:text><font color=red><html:errors property="zc_name"/></font>
            </label></td>
          </tr>
          <tr>
            <td height="34" background="images/background.jpg"><img src="images/point.gif" alt="" width="17" height="16"> <span class="word_Green">生产日期：</span></td>
          ...
          <tr>
            <td height="34" background="images/background.jpg"><img src="images/point.gif" alt="" width="17" height="16"><span class="word_Green">单价：</span></td>
            <td><label>
          ...
          <tr>
            <td height="37" background="images/background.jpg"><img src="images/point.gif" alt="" width="17" height="16"><span class="word_Green">生产厂商：</span></td>
            <td><label>
          ...
          <tr>
            <td height="38" background="images/background.jpg"><img src="images/point.gif" alt="" width="17" height="16"><span class="word_Green">入库时间：</span></td>
            <td><label>
          ...
          <tr>
            <td height="36" background="images/background.jpg"><img src="images/point.gif" alt="" width="17" height="16"><span class="word_Green">购买人：</span></td>
            <td><label>
              <html:text property="zc_buyer" styleClass="logininput" size="20"></html:text><font color=red><html:errors property="zc_buyer"/></font>
            </label></td>
          </tr>
          <tr>
            <td height="39" background="images/background.jpg"><img src="images/point.gif" alt="" width="17" height="16"><span class="word_Green">资产类型：</span></td>
            <td><label>
          ...
          <tr>
            <td height="35" background="images/background.jpg"><img src="images/point.gif" alt="" width="17" height="16"><span class="word_Green">资产状态：</span></td>
            <td><label>
          ...
          <tr>
            <td height="35" background="images/background.jpg"><img src="images/point.gif" width="17" height="16">备注信息：</td>
            <td><label>
