...
<table width="90%" border="0" cellspacing="0" cellpadding="0" align="center" >
  <tr >
    <td valign="bottom" height="50">
      <div align="left">
        <span class="title">
          <img src="  images/9.gif" width="36" height="30"></span><span class="word_orange STYLE1">修改用户信息        </span> </div>
    </td>
  </tr>
</table>
...
<tr bgcolor="#FFFFFF">
		<td width="46%" height="40" align="right" background="  images/bg.gif"><img src="  images/point.gif" width="17" height="16">员工编号：</td>
	  <td width="54%" background="  images/bg.gif" >
...
<td align="left" background="  images/bg.gif">
	...
	<tr bgcolor="#FFFFFF" >
	  <td height="31" colspan="2" align="center" background="  images/bg.gif">&nbsp;</td>
    </tr>
	<tr bgcolor="#FFFFFF" >
		<td colspan="2" align="center" background="  images/bg.gif">
