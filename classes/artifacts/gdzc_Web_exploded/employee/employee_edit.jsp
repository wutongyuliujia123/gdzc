...
<html>
	<head>
		...
		<script language="javascript" type="text/javascript" src="  js/pinbi.js"></script>
</head>
		...
		<table width="70%" border="0" align="center">
			<tr>
				<td>
				  ...
				  <tr>
							<td><img src="  images/7.gif" width="33" height="33"><span class="word_orange2"><strong>员工信息修改</strong></span>							</td>
					  </tr>
						<tr>
							<td>
									...
									<table width="98%" border="0" align="center"
										...
										<tr>
											<td width="17%" height="38">
												<img src="  images/point.gif" width="17" height="16 ">
												员工编号：
											</td>
											<td width="34%">
												<label>
