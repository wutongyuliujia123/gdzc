...
<html>
  ...
  <table width="80%" border="0" align="center">
    <tr>
      <td><img src=" images/weifu.gif" width="30" height="30"><span class="word_orange2"><strong>借用资产详细信息</strong></span></td>
    </tr>
    ...
    <tr>
      <td><img src=" images/7.gif" width="33" height="33"><strong>资产借用人信息：</strong></td>
    </tr>
    <tr>
      <td><table width="98%" border="0" align="center" background=" images/bg.gif" class="tableBorder">
        <tr>
          <td width="13%" height="34"><img src=" images/point.gif" width="17" height="16">员工编号：</td>
          <td width="27%"><label>
